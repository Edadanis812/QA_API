...
public class Get02 extends HerokuAppBaseUrl {
    ...
    public void get02(){
        ...
        //We have to send out data in Gherkin, Put specification,Action key word, what is the request
...
//        System.out.println(response.headers());
        ...
        //NOTE: //assertEquals( "Cowboy",response.header("Server") ); AND Assert.assertTrue(response.header("Server").contains("Cowboy"));
        //Both of them is doing the same thing.
